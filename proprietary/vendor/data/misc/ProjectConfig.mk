...
CUSTOM_HAL_IMGSENSOR = sp250a_mipi_raw gc5025_mipi_raw hi556_mipi_raw
CUSTOM_HAL_LENS = dummy_lens dummy_lens dummy_lens 
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = hi556_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR = sp250a_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = sp250a_mipi_raw gc5025_mipi_raw hi556_mipi_raw
...
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = hi556_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = sp250a_mipi_raw
...
MTK_BICR_SUPPORT = no
NSTART_PLATFORM=MT6580
NSTART_CUSTOM=G186
NSTART_MCP=MV88
NSTART_BUILD_BASE_PROJECT=k80hd_bsp_fwv_512m
NSTART_MAIN_IMGSENSOR = gc5025_mipi_raw_V88
NSTART_MAIN_BACKUP_IMGSENSOR = hi556_mipi_raw_V88
NSTART_SUB_IMGSENSOR = sp250a_mipi_raw_V88
NSTART_SAVE_FACTORY_REPORT=yes
NSTART_UNPINNING_BY_BACK=yes
NSTART_WT_APK=yes
NSTART_FIRST_LOGO = WT_FWVGA_LOGO
NSTART_SECOND_LOGO = WT_FWVGA_LOGO
NSTART_BOOT_ANIMATION = WT_FWVGA_BOOT_ANI
NSTART_SYSTEM_RING = WT
NSTART_PRODUCT_MODEL = Primo E9
NSTART_PRODUCT_BRAND = WALTON
NSTART_PRODUCT_NAME = Primo_E9
NSTART_PRODUCT_DEVICE = Primo_E9
NSTART_BUILD_HOST = Primo_E9
NSTART_PRODUCT_BOARD = Primo_E9
NSTART_PRODUCT_MANUFACTURER = WALTON
NSTART_BUILD_PRODUCT = Primo_E9
NSTART_TARGET_DEVICE = Primo_E9
NSTART_TARGET_PRODUCT = Primo_E9
NSTART_BUILD_FINGERPRINT = yes
NSTART_BT_MODEL = Primo__E9
NSTART_WLAN_SSID_MODEL = Primo__E9
NSTART_WIFI_DIRECT_MODEL = Primo__E9
NSTART_TARGET_AAPT_CHARACTERISTICS = default
NSTART_MMX_HARDWARE_VERSION = V1.0
NSTART_CUSTOMER_COMMON_PRO = WT
NSTART_ALARM_TIMEOUT = 10
NSTART_ALARM_SNOOZE = 10
NSTART_REMOVE_ANDROID_LAUNCHER = no
NSTART_ALARM_ALWAYS = yes
NSTART_MORE_RING = yes
NSTART_FAST_BOOT_OFF = yes
NSTART_CB_MESSAGE_ADD = yes
NSTART_COMMON_REMOVE = yes
NSTART_CB_MESSAGE_CUSTOM = Channel,50,true
NSTART_CUSTOM_BROWSER = yes
NSTART_CUSTOM_EMAIL_SIGN = yes
NSTART_DEFAULT_BRIGHTNESS = 255
NSTART_WINDOWN_ANIMATION_OFF = yes
NSTART_CAMERA_PICTURE_RATIO = 1.3333
NSTART_LUNCHER3_HIDE_SEARCHBAR = yes
NSTART_LUNCHER3_MENU_BG_ALP = yes
NSTART_DEFAULT_TIMEZONE = Asia/Dhaka
NSTART_DEFAULT_SOUND_NOTIFICATION = Rhea.ogg
NSTART_DEFAULT_SOUND_ALARM = Osmium.ogg
NSTART_DEFAULT_SOUND_RINGTONE = SlowGlow.WAV
NSTART_DEFAULT_SOUND_RINGTONE2 = SlowGlow.WAV
NSTART_ACCELEROMETER_MXC400X = yes
NSTART_CALL_AUTO_RECORD = yes
NSTART_REMOVE_IP_DIAL_MENU = yes
NSTART_CAMERA_SHUT_SOUND = on
NSTART_CAMERA_VIDEO_AUTO_FOCUS = yes
NSTART_LAUNCHER_WALLPAPER_DEFAULT = WT_FWVGA_E9
NSTART_LAUNCHER_WALLPAPER_EXTRA = WT_FWVGA_E9
NSTART_LAUNCHER3_ALL_ICON_BG=no
MMX_BUILD_GMS=android-walton
NSTART_GALLERY_EDIT_IMGAE_REMAIN_OLD = yes
NSTART_SETTING_HIDE_ONESIM_NOTICE = yes
NSTART_CONTACTS_SPEEDDIALER = yes
NSTART_CONTACT_SHOW_COUNT = yes
NSTART_MENUKEY_SHOW_RECENTAPP = yes
NSTART_STATUSBAR_BATTERY_PERCENT = yes
NSTART_TOTAL_SPACE = yes
NSTART_SETTING_NETWORK_STYLE = yes
NSTART_DUALSIM_RINGTONG = yes
NSTART_MUSIC_PREBUTTON = yes
#NSTART_MUSIC_SHOW_LYR = yes
NSTART_MUSIC_SEEK_BAR = yes
NSTART_DATE_FORMAT_DEFAULT = dd-MM-yyyy
NSTART_SKIP_SETUP_WIZARD=yes
NSTART_CAMERA_UI_IPHONE=yes
#NSTART_FILES_COPY=phone
NSTART_3POINT_TOUCH_SCREENSHOT = no
NSTART_SYNC_RINGTONE_UI = yes
#NSTART_BUILD_NUMBER = 
NSTART_MISC_DEVICE_INFO=yes
MTK_MXC400X=yes
NSTART_USB_DEFAULT_CHARGING=yes
NSTART_GOOGLE_KEY_PREFIX=Primo_E9
NSTART_ADD_SOUNDRECORD=yes
NSTART_SMS_SALES_TRACK=yes
NSTART_RESTORE_DEFAULT_RINGTONE=yes
NSTART_SALES_STATISTICS_PROJECTNAME=G186_WT_E9
NSTART_BUILD_DISPLAY_ID = Primo_E9_SW_V1.6_21092018
NSTART_SOFTWARE_VERSION = Primo_E9_SW_V1.6_21092018
#adupsfota start
